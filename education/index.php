<?php include('/schoolmanagement_admin/schoolmanagement/config/Database.php');
	...
	<div class="col-md-6 w3l_about_bottom_right one">
		<div class="abt-w3l">
			<div class="header-w3l">
				...
				<form action="/schoolmanagement_admin/schoolmanagement/pages/admission.php" method="post" class="mod2">
